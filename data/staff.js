export const STAFF_ROLE_PACKS = {
  ...
  business_success_manager: {
    ...
    permissions: ["businesses.read", "businesses.update", "support.read", "reports.read"],
  ...
  operations_manager: {
    ...
    permissions: ["operations.*", "support.*", "claims.*", "people.approve", "reports.read"],
  ...
  content_editor: {
    ...
    permissions: ["content.read", "content.write", "help.write", "announcements.write"],
