...
export function LoginApp({ initialPortal = "customer" }) {
  ...
  const description = mode === "signup" ? "Email and password create your primary Spotly identity. Google, Apple, and phone can be linked afterward." : mode === "reset" ? "Enter the email used for your Spotly account." : "One identity across customer, business, staff, driver, and permitted admin experiences.";
