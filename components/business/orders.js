...
export function OrdersView() {
  const { orders, ordersLoading, ordersError, products, user, archetype, selectedBranchId } = useBusinessWorkspace();
  const flow = flowFor(archetype);
